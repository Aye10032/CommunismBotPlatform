...
public class AudioFunction extends BaseFunc {
    ...
    public AudioFunction(CommunismBot communismBot) {
        super(communismBot);
        commander = new CommanderBuilder<SimpleMsg>()
                ...
                .run((msg)->{
                    if (msg.getFromClient() != 2155231604L){
                        String filename = communismBot.getAudioFromMsg(msg).getName();
                        communismBot.logInfo("下载音频文件"+filename);
                        try {
                            ...
                            if (response.body() != null) {
                                ...
                                if (element.isJsonObject()) {
                                    ...
                                    if (code == 201) {
                                        ...
                                        communismBot.replyMsg(msg, "来点大家想看的东西");
