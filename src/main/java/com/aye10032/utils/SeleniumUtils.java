...
public class SeleniumUtils {
    ...
    public synchronized static File getScreenshot(WebDriver driver, String url, String outFileName, int timeOut, String... js) throws IOException, InterruptedException {
        try {
            ...
            CommunismBot.logInfoStatic("Chrome Dirver switch to" + url);
            ...
            CommunismBot.logInfoStatic(String.format("截图网页自适应获得高度%d", height.intValue()));
            for (String s : js) {
            ...
            CommunismBot.logInfoStatic("Chrome Dirver switch to about:blank");
