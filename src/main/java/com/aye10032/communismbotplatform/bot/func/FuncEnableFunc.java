...
import com.aye10032.communismbotplatform.foundation.utils.ConfigLoader;
...
public class FuncEnableFunc extends BaseFunc {
    ...
    public FuncEnableFunc(CommunismBot bot) {
        super(bot);
    }
    ...
    public Map<Long, List<String>> load() {
        return ConfigLoader.load(new File(bot.appDirectory + "/disable.json")
                , new TypeToken<Map<Long, List<String>>>() {
                }.getType());
    }

    public void save() {
        ConfigLoader.save(new File(bot.appDirectory + "/disable.json")
                , new TypeToken<Map<Long, List<String>>>() {
                }.getType(), disableList);
    }
}
